...
<%@ page import="com.rktirtho.amarbazar.model.UserResponse" %>
...
<head>
    <%
        // We are taking login status from the session to check is user loged in or not
        // If not loged in then redirect to the login page
        String isUserLogin = (String) session.getAttribute("loginStatus");
